module.exports = function(sequelize, DataTypes) {
    ...
    var attributes = {
        ...
        v_from_name: {type: DataTypes.STRING, allowNull: false},
        v_cc: {type: DataTypes.STRING, allowNull: false},
        v_bcc: {type: DataTypes.STRING, allowNull: false},
        v_attach: {type: DataTypes.STRING, allowNull: false},
